<?php
   ...
   */
   ...
   class objmysql extends db{
        private static $sqlins = null;
		private $conn = null;
        private $conf = array();
		public function __construct(){
		   $this->conf = conf::getInstance(); //得到配置信息的数组
	   ...
	   public function db_connect($host,$user,$pwd){
	          $this->conn = new mysqli($host,$user,$pwd,$this->conf->db);
	    ...
	    //调用数据库--暂时可以不需要使用，为什么要写呢，一是因为父类是抽象类，子类必须去继承它所有的抽象方法 二 可以在mysqli里使用构造方法连接库使用
